...
> Premi playtime con GUI modificabile.
...
**DadaPlayTime 1.0** is a custom Minecraft plugin for Paper/Spigot servers.
...
| Main class | `it.dadasmp.playtime.DadaPlayTimePlugin` |
...
| --- | --- | --- |
| `dadaplaytime.use` | `true` | Permette di usare /playtime. |
| `dadaplaytime.admin` | `op` | Permette di usare /playtime gui admin e /playtime reload. |
